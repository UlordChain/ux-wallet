...
public class UshareToken extends Contract {
    ...
    public RemoteCall<TransactionReceipt> initialize(String _dev, String _pool, String _foundation, String _operation) {
        final Function function = new Function(
                FUNC_INITIALIZE, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(_dev), 
                new org.web3j.abi.datatypes.Address(_pool), 
                new org.web3j.abi.datatypes.Address(_foundation), 
                new org.web3j.abi.datatypes.Address(_operation)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
